...
fn main() {
	...
	if true {	
		// Parameters
		let locations = vec![-0.0100000000, -0.0072102272, -0.0051987376, -0.0037484079, -0.0027026872, -0.0019486989, -0.0014050562, -0.0010130774, -0.0007304518, -0.0005266724, -0.0003797427, -0.0002738031, -0.0001974183, -0.0001423431, -0.0001026326, -0.0000740004, -0.0000533560, -0.0000384709, -0.0000277384, -0.0000200000];// vec![-0.0080000000, -0.0058363249, -0.0042578361, -0.0031062643, -0.0022661460, -0.0016532455, -0.0012061098, -0.0008799061, -0.0006419272, -0.0004683120, -0.0003416526, -0.0002492494, -0.0001818376, -0.0001326579, -0.0000967793, -0.0000706045, -0.0000515088, -0.0000375778, -0.0000274145, -0.0000200000]; // vec![-0.0000600000, -0.0000566291, -0.0000534476, -0.0000504448, -0.0000476107, -0.0000449359, -0.0000424113, -0.0000400285, -0.0000377797, -0.0000356571, -0.0000336539, -0.0000317631, -0.0000299786, -0.0000282944, -0.0000267047, -0.0000252044, -0.0000237884, -0.0000224519, -0.0000211905, -0.0000200000]; // vec![-4e-5]; //
		let scales = vec![0.0000100000, 0.0000143845, 0.0000206914, 0.0000297635, 0.0000428133, 0.0000615848, 0.0000885867, 0.0001274275, 0.0001832981, 0.0002636651, 0.0003792690, 0.0005455595, 0.0007847600, 0.0011288379, 0.0016237767, 0.0023357215, 0.0033598183, 0.0048329302, 0.0069519280, 0.0100000000]; // vec![0.0000100000, 0.0000142165, 0.0000202110, 0.0000287331, 0.0000408486, 0.0000580726, 0.0000825592, 0.0001173706, 0.0001668606, 0.0002372181, 0.0003372423, 0.0004794423, 0.0006816015, 0.0009690021, 0.0013775867, 0.0019584530, 0.0027842444, 0.0039582349, 0.0056272444, 0.0080000000]; // vec![0.0000100000, 0.0000117078, 0.0000137073, 0.0000160482, 0.0000187889, 0.0000219977, 0.0000257544, 0.0000301527, 0.0000353022, 0.0000413311, 0.0000483897, 0.0000566536, 0.0000663290, 0.0000776566, 0.0000909188, 0.0001064459, 0.0001246247, 0.0001459081, 0.0001708263, 0.0002000000]; // vec![1e-5]; // 
		// let shapes_and_rates = vec![(0., 1000.), (-2.5, 1000.), (0., 7000.)]; // 
		let shapes =vec![0., -1., -2., -3., -4.]; // vec![0., -2.5, -5., -7.5, -10.]; // vec![-5.]; // 
		let rates = vec![0., 1000., 3000., 5000., 7000.]; // vec![1e3]; // 
		let variance_samples = 1000;
