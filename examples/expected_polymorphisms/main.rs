...
fn main() {
	...
	if true {	
		// Parameters
		// mu
		let locations = vec![-0.1000000000, -0.0638730079, -0.0407976113, -0.0260586615,  -0.0166444509, -0.0106313114, -0.0067905384, -0.0043373211,  -0.0027703775, -0.0017695234, -0.0011302478, -0.0007219233,  -0.0004611141, -0.0002945275, -0.0001881235, -0.0001201602,  -0.0000767499, -0.0000490225, -0.0000313121, -0.0000200000];
		// sigma
		let scales = vec![0.0000100000, 0.0000162378, 0.0000263665, 0.0000428133, 0.0000695193,  0.0001128838, 0.0001832981, 0.0002976351, 0.0004832930, 0.0007847600,  0.0012742750, 0.0020691381, 0.0033598183, 0.0054555948, 0.0088586679,  0.0143844989, 0.0233572147, 0.0379269019, 0.0615848211, 0.1000000000];
		// let shapes_and_rates = vec![(0., 1000.), (-2.5, 1000.), (0., 7000.)]; // 
		// alpha
		let shapes =vec![0., -2., -4.];
		// beta
		let rates = vec![10000., 25000., 50000., 100000.]; // vec![1e3]; // 
		
		// Conditional expectation bounds for s
		let lower_bound = -1.0;
		let upper_bound = 1.0;
